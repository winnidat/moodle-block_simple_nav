...
class block_simple_nav_renderer extends plugin_renderer_base {
    ...
    protected function sn_print_item(array $item) {
        ...
        $linkid = $item['myid'];
        $item['myid'] = html_writer::random_id();
        $itemid = $item['myid'];
        ...
        if ($itemtype == 'category') {
            $myurl = $CFG->wwwroot . '/course/index.php?categoryid=' . $linkid;
...
elseif ($itemtype == 'course') {
            ...
            // $mycollapsed =' collapsed';
            $myurl = $CFG->wwwroot . '/course/view.php?id=' . $linkid;
...
elseif ($itemtype == 'module') {
            $myurl = $CFG->wwwroot . '/mod/' . $itemicon . '/view.php?id=' . $linkid;
